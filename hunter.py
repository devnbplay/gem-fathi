...
async def maybe_alert(s, sc, c, why):
    ...
    can_enter = (safety["status"] == "PASS")
    if sc >= ENTER_SCORE and c["p5"] <= 18 and can_enter:
        verdict = "🚨 ENTER — SAFETY PASSED"
    elif sc >= MIN_ALERT:
    ...
    if safety["status"] == "PASS":
        ...
        action = "Momentum + automated safety gate passed. Still high risk; use the invalidation."
    else:
